# Day 29｜方案设计：把模型变成客户愿意签字的实施计划

> **学习时长：约 20–30 分钟**  
> **今天的成果：** 能给出范围、架构、风险、验收与阶段路线，而不是只展示功能清单。
...
方案页最少包括：目标决策、对象范围、数据接入、用户流程、权限、里程碑、验收指标、客户责任与开放问题。

## 把它放进真实现场

一份可信方案要让客户知道：第一阶段能得到什么、需要提供什么数据、哪些风险仍未解决、如何判定成功。不要承诺“AI 自动解决运营问题”。
...
flowchart LR
  ...
  Build["Build"] --> Pilot["Pilot"]
  Pilot["Pilot"] --> Acceptance["Acceptance"]
...
为 6 周胸痛 MVP 写出三个客户侧前置条件。

建议先在纸上完成。写不出来时，不要急着查工具：通常说明你还没有把“现实中的一个决定”说清楚。

## 参考答案与检查清单

提供十个去标识化真实样本及字段说明；指定急诊/导管室业务负责人每周参与评审；确认只读接入与通知 Action 的合规边界。缺少任一项都应调整计划。
